...
const FaqItem = ({ question, answer }) => {
  ...
  return (
    <div className="en12 border rounded-lg mx-5 shadow-lg  text-gray-600 px-8 my-4">
      <button
        className="w-full text-left flex justify-between items-center py-4 text-base md:text-lg text-black font-bold dark:hover:text-indigo-500 dark:text-slate-200 "
      ...
      {isOpen && (
        <div className="py-4 dark:text-slate-200">
