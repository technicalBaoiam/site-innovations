  ...
  const handleSubmit = async (e) => {
    ...
    if (nameParts.length < 2 || nameParts[0] === "" || nameParts[1] === "") {
      ...
      const data = {
        ...
        email: formData.email,
        phone: formData.phone,
        enquiry_type: formData.enquiry_type, // Updated here
        message: formData.message,
      };

      try {
        const response = await axios.post(
          "https://api.baoiam.com/api/contact-us/",
          data
        );
      ...
      <section className="py-2 px-4 md:px-24 dark:bg-black rounded-xl">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-6 lg:gap-10 justify-center">
          <div className="con lg:w-2/4 xl:w-2/5 dark:text-white p-4 md:p-6 lg:p-8 rounded-lg border lg:py-6">
            ...
            <form id="form1" className="space-y-3" onSubmit={handleSubmit}>
              {/* Full Name */}
              <div>
                <label
                  htmlFor="fullname"
              ...
              <div>
                ...
                <input
                  id="email"
                  type="email"
                  name="email" // Consistent with formData
                  value={formData.email}
                  className="w-full px-3 py-2 dark:bg-slate-800 border border-gray-300 rounded-md text-xs"
                  placeholder="Enter your E-mail"
                  onChange={handleChange}
              ...
              <div className="relative inline-block w-full">
                <select
                  id="inquiryType"
                  name="enquiry_type" // Updated name
                  className="border px-3 py-2 pr-10 dark:bg-slate-800 rounded focus:outline-none focus:border-gray-300 appearance-none w-full bg-white cursor-pointer text-sm"
                  required
              ...
              <div className="flex items-start">
                <input
                  id="consent"
                  name="Consent"
                  checked={formData.Consent || false} // Ensure it's controlled
                  type="checkbox"
                  className="mr-2 h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
                  onChange={handleChange}
                  required
          ...
          <div className="lg:w-1/3 space-y-4">
            <div className="con1 dark:bg-black p-6 lg:p-8 lg:py-6">
              ...
              <div className="flex justify-start gap-4 mt-6">
                ...
                <a
                  href="https://www.instagram.com/baoiam_innovations/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-black dark:text-white hover:text-gray-500"
                >
                ...
                <a
                  href="https://www.linkedin.com/company/baoiam-innovations-pvt-ltd/mycompany/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-black dark:text-white hover:text-gray-500"
                >
                ...
                <a
                  href="https://twitter.com/BAOIAM1"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-black dark:text-white hover:text-gray-500"
                >
                  <FaTwitter size={22} className="icon3" /> {/* Updated Icon */}
                </a>
              </div>
              ...
              <div className="h-56 w-full mt-6 md:mt-8">
                <iframe
                  ...
                  aria-hidden="false"
                  tabIndex="0"
                  title="Baoiam Innovations Location" // Added title for accessibility
                ></iframe>
              </div>
            </div>
          </div>
